...
function Training() {
	...
	const { profile, file, selectedModel, recommendations, compareModels, setCompareModels, trainingConfig, trainingResult, comparisonResults, selectedComparisonModel, setSelectedModel, setTrainingConfig, setTrainingResult, setComparisonResults, setSelectedComparisonModel } = useDataset();
	...
	const classLabels = useMemo(() => {
		...
		return profile?.class_distribution ? Object.keys(profile.class_distribution) : [];
	}, [splitStats, profile?.class_distribution]);
	const splitClassData = useMemo(() => {
		if (splitStats?.train_class_dist && splitStats?.val_class_dist && splitStats?.test_class_dist) return [
			...
			classLabels.forEach((label) => {
				row[label] = item.dist?.[label] ?? 0;
			});
			return row;
		});
		if (!splitStats_live || classLabels.length === 0 || !profile?.class_distribution) return [];
		const total = Object.values(profile.class_distribution).reduce((sum, value) => sum + value, 0);
		if (total === 0) return [];
		return [
			{
				split: "Train",
				count: splitStats_live.train_n
			},
			{
				split: "Val",
				count: splitStats_live.val_n
			},
			{
				split: "Test",
				count: splitStats_live.test_n
			}
		].map((item) => {
			const row = { split: item.split };
			classLabels.forEach((label) => {
				const ratio = (profile.class_distribution?.[label] ?? 0) / total;
				row[label] = Number((ratio ?? 0).toFixed(4));
			});
			return row;
		});
	}, [
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(BarChart3, { className: "h-5 w-5 text-primary" }), /* @__PURE__ */ jsx("h2", {
							...
							children: "Data Split (configured in Step 3 — before feature engineering)"
						})]
					}),
					/* @__PURE__ */ jsxs("div", {
							...
							/* @__PURE__ */ jsxs("div", { children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("input", {
										...
										children: [(displaySplitStats?.train_pct ?? 0).toFixed(0), "%"]
									})]
								}),
								displaySplitStats && /* @__PURE__ */ jsxs("p", {
									className: "text-xs text-muted-foreground mt-1",
									children: [displaySplitStats.train_n.toLocaleString(), " samples"]
								})
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("label", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("input", {
										...
										className: "text-sm font-mono w-12 text-right",
										children: [(displaySplitStats?.val_pct ?? 0).toFixed(0), "%"]
									})]
								}),
								displaySplitStats && /* @__PURE__ */ jsxs("p", {
									className: "text-xs text-muted-foreground mt-1",
									children: [displaySplitStats.val_n.toLocaleString(), " samples"]
								})
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("label", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("input", {
										...
										className: "text-sm font-mono w-12 text-right",
										children: [(displaySplitStats?.test_pct ?? 0).toFixed(0), "%"]
									})]
								}),
								displaySplitStats && /* @__PURE__ */ jsxs("p", {
									className: "text-xs text-muted-foreground mt-1",
									children: [displaySplitStats.test_n.toLocaleString(), " samples"]
								})
							] })
						]
					}),
					...
					/* @__PURE__ */ jsx("p", {
						...
						children: "Feature engineering will be re-learned on the training split and then applied to validation/test without using their labels. To change the split ratio or seed, return to Model Selection."
					})
				]
			}),
			displaySplitStats && classLabels.length > 0 && /* @__PURE__ */ jsxs("section", {
				className: "rounded-xl border border-border bg-card p-6 shadow-elegant",
				children: [
					/* @__PURE__ */ jsx("h2", {
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: (() => {
							const distributionSource = splitStats?.train_class_counts ? Object.entries(splitStats.train_class_counts).map(([label, count]) => ({
								label,
								count: Number(count)
							})) : profile.class_distribution ? Object.entries(profile.class_distribution).map(([label, count]) => ({
								label,
								count: Number(count)
							})) : [];
