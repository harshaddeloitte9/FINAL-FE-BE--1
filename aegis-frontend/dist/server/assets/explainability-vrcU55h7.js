...
import { o as shapWaterfall, t as featureImportance } from "./mock-data-2vCp6sQZ.js";
...
import { Bar, BarChart as BarChart$1, CartesianGrid, Tooltip, XAxis, YAxis } from "recharts";
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Button, {
						onClick: () => navigate({ to: "/ecl-provisions" }),
						className: "gap-2",
						children: ["Continue to ECL & Provisions", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
					}),
					/* @__PURE__ */ jsxs(Button, {
